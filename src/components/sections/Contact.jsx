...
export const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        emailjs
        .sendForm(import.meta.env.VITE_SERVICE_ID, import.meta.env.VITE_TEMPLATE_ID, e.target, import.meta.env.VITE_PUBLIC_KEY).then((result) => {
            alert("Message Sent!");
            ...
            <div className="px-4 w-150">
                ...
                <form action="" className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="relative">
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-500/10"
                        placeholder="Whatchu got for me" 
